...
void SerializeFoodWastageRecordToJSON(
  ...
  // COMPLETED TODO 1. Use the accessor/getter function for date from the
  ...
  std::string meal = record.Meal();
  // COMPLETED TODO 2. Use the accessor/getter function for meal from the
  ...
  std::string food_name = record.FoodName();
  // COMPLETED TODO 3. Use the accessor/getter function for food name from the
  ...
  double quantity = record.QuantityInOz();
  // COMPLETED TODO 4. Use the accessor/getter function for quantity from the
  ...
  std::string wastage_reason = record.WastageReason();
  // COMPLETED TODO 5. Use the accessor/getter function for wastage reason from
  // the FoodWastageRecord class object to get the wastage reason and store it
  // in the wastage_reason string declared above.
  writer->String(wastage_reason.c_str());

  writer->String("disposal_mechanism_");  // DO NOT MODIFY
  std::string disposal_mechanism = record.DisposalMechanism();
  // COMPLETED TODO 6. Use the accessor/getter function for disposal mechanism
  // from the FoodWastageRecord class object to get the disposal mechanism and
  // store it in the disposal_mechanism string declared above.
  writer->String(disposal_mechanism.c_str());

  writer->String("cost_");  // DO NOT MODIFY
  double cost = record.Cost();
  // COMPLETED TODO 7. Use the accessor/getter function for cost from the
...
FoodWastageRecord DeserializeFoodWastageRecordFromJSON(
  ...
  /* COMPLETED TODO 1. Use the mutator/setter function for date from the
  ...
  /* COMPLETED TODO 2. Use the mutator/setter function for meal from the
  ...
  /* COMPLETED TODO 3. Use the mutator/setter function for food name from the
  ...
  /* COMPLETED TODO 4. Use the mutator/setter function for quantity from the
  ...
  /* COMPLETED TODO 5. Use the mutator/setter function for wastage reason from
   * the FoodWastageRecord class to set the wastage reason in `record` object.
   * You can get the wastage reason from JSON object as follows:
  ...
  /* COMPLETED TODO 6. Use the mutator/setter function for disposal mechanism
   * from the FoodWastageRecord class to set the disposal mechanism in `record`
  ...
  /* COMPLETED TODO 7. Use the mutator/setter function for cost from the
...
// JSON object.
crow::json::wvalue FoodWastageReportToCrowJSON(FoodWastageReport &report) {
  ...
  most_commonly_wasted_foods = report.MostCommonlyWastedFoods();
  ...
  // in the vector declared above.
  most_common_wastage_reasons = report.MostCommonWastageReasons();
  ...
  // result in the vector declared above.
  most_costly_waste_producing_meals = report.MostCostlyWasteProducingMeals();
  ...
  // declared.
  total_cost_of_wastage = report.TotalCostOfFodWasted();
...
FoodWastageRecord QueryStringToFoodWastageRecord(
  ...
  // COMPLETED TODO 1. Get the date from the query_string using
  ...
  // COMPLETED TODO 5. Get the wastage reason from the query_string using
  ...
  // COMPLETED TODO 6. Get the disposal mechanism from the query_string using
  ...
  // COMPLETED TODO 7. Get the cost from the query_string using
...
bool FoodWastageTrackerBackend::WriteRecordsToJSONFile() const {
  ...
  writer.StartArray();
  const std::vector<FoodWastageRecord> records = tracker_.GetRecords();
  // TODO: Call the member function in the FoodWastageTracker class, on the
  // member object that you added in food_wastage_tracker_backend.h, that
...
crow::json::wvalue FoodWastageTrackerBackend::AddRecord(
  ...
  // COMPLETED TODO: Call the member function in the FoodWastageTracker class,
  // on the member object that you added in food_wastage_tracker_backend.h, that
  // adds a `record` and returns the status of the add operation as a bool.
...
crow::json::wvalue FoodWastageTrackerBackend::GetRecords() const {
  ...
  // returns all the FoodWastageRecord objects. Store the returned records in
  // the vector declared above. Also change the data type of the records vector
  // to `const std::vector<FoodWastageRecord>&`. COMPLETE
...
crow::json::wvalue FoodWastageTrackerBackend::GetFoodWastageReport() const {
  FoodWastageReport generated_report = tracker_.GetFoodWastageReport();
  // TODO: Call the member function in the FoodWastageTracker class, on the
  // member object that you added in food_wastage_tracker_backend.h, that
